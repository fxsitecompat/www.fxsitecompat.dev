...
---
Firefox 55 has added the support for the [`appearance`](https://developer.mozilla.org/en-US/docs/Web/CSS/appearance) CSS property along with `-webkit-appearance` as an alias for WebKit/Blink compatibility. Meanwhile, the non-standard [`-moz-appearance`](https://developer.mozilla.org/en-US/docs/Web/CSS/-moz-appearance) property is no longer available to web content.
