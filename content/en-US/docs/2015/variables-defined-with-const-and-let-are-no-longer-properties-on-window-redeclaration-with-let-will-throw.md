...
Note that the `let` statement [no longer requires an explicit JavaScript version](https://www.fxsitecompat.com/en-US/docs/2015/let-statement-no-longer-requires-explicit-javascript-version/).
