...
**Update**: The legacy non-`Map`-like `getStats` access has been [removed with Firefox 66](https://www.fxsitecompat.com/en-CA/docs/2018/legacy-peerconnection-getstats-support-has-been-removed/).
